                        ...
                        <div class="card-body">
                            <div class="row px-5">                                  
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                        ...
                                        <input id="inputPorcentaje" name="inputPorcentaje" type="number" class="form-control form-control-sm" step="0.01" min="0.00" required>
                                </div>                                
                                <div class="form-group col-sm-12 col-md-12">
                                    <label for="inputEvidencia" class="col-form-label-sm">Evidencia <span class="text-danger">*</span></label> 
                                    <textarea class="form-control form-control-sm" name="inputEvidencia" id="inputEvidencia" cols="30" rows="3" required></textarea>
                                </div> 
                                <div class="form-group col-sm-12 col-md-12">
